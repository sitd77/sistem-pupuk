...
@Component({
  selector: 'app-pembagian-pupuk',
  templateUrl: './pembagian-pupuk.component.html',
  styleUrls: ['./pembagian-pupuk.component.scss'],
})
export class PembagianPupukComponent implements OnInit, OnDestroy {
  // var's
  sub: Subscription;
  ...
  onDetailUpdated(result: IResultDetail): void {
    ...
    const per = result.permohonan;
    per.datasource.data = newData;
    this.submitForm(per);
  }
}
